...
<body>
	...
	<div class="all">
		...
		<section id="add-course" class="tab-content">
			<% String msg = (String) session.getAttribute("notadded");
			if (msg != null) { %>
				<p class="msg"><%=msg%></p>
			<% }
			...
			<form id="addCourseForm" action="courseadd" method="post">
				...
				<div class="date_box">
					...
					<div class="form-group">
						<label for="courseDuration">Course Duration (in weeks)</label> <input
							type="number" id="courseDuration" name="courseDuration"
							placeholder="Enter duration in weeks" required>
					</div>
				</div>
				<div class="form-group">
					<label for="price">Price</label> <input type="number" id="price"
						name="price" placeholder="Enter course price" step="0.01" required>
				</div>
